...
import numpy as np
from spiceypy import furnsh, ckobj, ckcov, wncard, wnfetd, str2et, sct2e, scdecd, etcal, pxform
...
ScanPlatformCK = "data/spice/ck/vg2_nep_version1_type1_iss_sedr.bc"
...
for i in range(wncard(cover)):
    t0,t1=wnfetd(cover,i)
    assert t0==t1,"Not a discrete pointing kernel like expected"
    et0=sct2e(-32,t0)
    print(f"{t0:20.7f},{scdecd(-32,t0)},{et0:20.7f},{etcal(et0)}")
    ets.append(et0)
    sclks.append(t0)
...
et0 = str2et("1989-01-01 00:00:00 TDB")
et1 = str2et("1990-01-01 00:00:00 TDB")
...
with open('v2n_msopck_data.txt', 'w') as ouf:
    for i_nac in range(1, len(eet)):
        ...
        if t00 > t01:
            ...
            print("Segment 0 length 0 -- skipping")
        elif t00 < t01:
            print(("%25.15e %25.15e" +
                   " 0 %25.15e %25.15e" +
                   " 0 0 0") % (t00, t01,
        ...
        if t10 < t01:
            ...
            print("Segment 1 length 0 -- skipping")
        elif t10 < t11:
            print(("%25.15e %25.15e" +
                   " 0 %25.15e %25.15e" +
                   " 0 %25.15e 0") % (t10, t11,
        ...
        if t20 < t11:
            ...
            print("Segment 2 length 0 -- skipping")
        elif t20 < t21:
            print(("%25.15e %25.15e" +
                   " 0 %25.15e %25.15e" +
                   " 0 0 %25.15e") % (t20, t21,
        ...
        if t30 < t21:
            ...
            print("Segment 3 length 0 -- skipping")
        elif t30 < t31:
            print(("%25.15e %25.15e" +
                   " 0 %25.15e %25.15e" +
                   " 0 0 0") % (t30, t31,
...
try:
    os.remove("data/spice/ck/v2n_slew.bc")
except FileNotFoundError:
    pass  # no error, file is already not present
subprocess.call("~/bin/msopck v2n_msopck_header.txt v2n_msopck_data.txt data/spice/ck/v2n_slew.bc",
                shell=True)